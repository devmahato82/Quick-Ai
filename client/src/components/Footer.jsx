        ...
        <div class="md:max-w-96">
           <img src={assets.logo} alt="logo" className='w-32 sm:w-44' />
            <p class="mt-6 text-sm">
                Experience the power of AI with QuickAi. <br/> Transform your content creation with our suite of premium AI tools . Write articles, generate images, and ehance your workflow.
            </p>
        </div>
            ...
            <div>
                ...
                <div class="text-sm space-y-2">
                    ...
                    <div class="flex items-center gap-2 pt-4">
                        ...
                        <button class="bg-primary w-24 h-9 text-white rounded">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
